...
<template>
  ...
  <Th07Summary v-if="info.game == CONSTANTS.GAME.TH07.ID" :filename="file.name" :info="info"></Th07Summary>
  <Th08Summary v-if="info.game == CONSTANTS.GAME.TH08.ID" :filename="file.name" :info="info"></Th08Summary>
  <Th09Summary v-if="info.game == CONSTANTS.GAME.TH09.ID" :filename="file.name" :info="info"></Th09Summary>
  ...
  <Th128Summary v-if="info.game == CONSTANTS.GAME.TH128.ID" :filename="file.name" :info="info"></Th128Summary>
  <Th13Summary v-if="info.game == CONSTANTS.GAME.TH13.ID" :filename="file.name" :info="info"></Th13Summary>
  <Th14Summary v-if="info.game == CONSTANTS.GAME.TH14.ID" :filename="file.name" :info="info"></Th14Summary>
  <Th15Summary v-if="info.game == CONSTANTS.GAME.TH15.ID" :filename="file.name" :info="info"></Th15Summary>
  <Th16Summary v-if="info.game == CONSTANTS.GAME.TH16.ID" :filename="file.name" :info="info"></Th16Summary>
  <Th17Summary v-if="info.game == CONSTANTS.GAME.TH17.ID" :filename="file.name" :info="info"></Th17Summary>
  <Th18Summary v-if="info.game == CONSTANTS.GAME.TH18.ID" :filename="file.name" :info="info"></Th18Summary>
</template>
