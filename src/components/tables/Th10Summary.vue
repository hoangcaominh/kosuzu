...
<template>
  <div class="grid">
    <Transition name="replay-slide">
      <table
        class="container table-overlap border border-separate border-slate-500 text-left shadow-lg shadow-th10/50"
        v-show="!stagesActive"
      >
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            <Button
              class="mx-2 my-1 bg-th10 hover:bg-th10/75 active:bg-th10/50 border-transparent"
              v-if="
