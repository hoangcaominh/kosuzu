...
<template>
  <div class="grid">
    <Transition name="replay-slide">
      <table
        class="container table-overlap border border-separate border-slate-500 text-left shadow-lg shadow-th14/50"
        v-show="!stagesActive"
      >
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            <Button
              class="mx-2 my-1 bg-th14 hover:bg-th14/75 active:bg-th14/50 border-transparent"
              v-if="
