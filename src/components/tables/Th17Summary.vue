...
<template>
  <div class="flex flex-row space-x-3">
    <table
      class="container border border-separate border-slate-500 text-left shadow-lg shadow-th17/50"
    >
      <thead>
        <tr>
          <th class="border border-slate-500 bg-th17 text-slate-100 px-3 py-1" colspan="3">
            {{ filename }}
          </th>
        </tr>
      </thead>
    ...
    <Transition name="stages-slide">
      ...
      >
        <thead>
          <tr>
            <th class="border border-slate-500 bg-th17 text-slate-100 px-3 py-1" colspan="2">
              Stages
            </th>
          </tr>
        </thead>
