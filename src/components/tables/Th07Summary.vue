...
<template>
    <div class="flex flex-row space-x-3">
        <table class="container border border-separate border-slate-500 text-left shadow-lg shadow-th07/50">
            <thead>
                <tr>
                    <th class="border border-slate-500 bg-th07 text-slate-100 px-3 py-1" colspan="3">{{ filename }}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border border-slate-500 px-3 py-1">{{ $t(`table.values.${info.game}.shot[${info.shot}]`) }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <Button
                        ...
                        v-if="info.type === CONSTANTS.REPLAY_TYPE.FULL_GAME && ![CONSTANTS.DIFFICULTY.EXTRA, CONSTANTS.DIFFICULTY.PHANTASM].includes(info.difficulty)"
        ...
        <Transition name="stages-slide">
            <table class="container border border-separate border-slate-500 text-left shadow-lg shadow-th07/50" v-show="stagesActive">
                <thead>
                    <tr>
                        <th class="border border-slate-500 bg-th07 text-slate-100 px-3 py-1" colspan="2">Stages</th>
                    </tr>
                </thead>
                <tbody>
