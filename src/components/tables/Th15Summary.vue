...
<template>
    <div class="flex flex-row space-x-3">
        <table class="container border border-separate border-slate-500 text-left shadow-lg shadow-th15/50">
            <thead>
                <tr>
                    <th class="border border-slate-500 bg-th15 text-slate-100 px-3 py-1" colspan="3">{{ filename }}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <Button
                        class="mx-2 my-1 bg-th15 active:bg-th15/50"
        ...
        <Transition name="stages-slide">
            <table class="container border border-separate border-slate-500 text-left shadow-lg shadow-th15/50" v-show="stagesActive">
                <thead>
                    <tr>
                        <th class="border border-slate-500 bg-th15 text-slate-100 px-3 py-1" colspan="2">Stages</th>
                    </tr>
                </thead>
                <tbody>
